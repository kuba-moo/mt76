...
#define MT_CMB_CTRL_TRSW0_AS_WL_ANT_SEL	BIT(12)
...
#define MT_WLAN_FUN_CTRL_WAKE_HOST	BIT(7) /* aka ACC_BT */
...
#define MT_RF_CSR_CFG_WRITE		BIT(30)
#define MT_RF_CSR_CFG_BUSY		BIT(31)
...
#define MT_AUTOWAKEUP_CFG		0x1208
